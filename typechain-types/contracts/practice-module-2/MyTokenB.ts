...
export interface MyTokenBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MyTokenB extends BaseContract {
  connect(runner?: ContractRunner | null): MyTokenB;
  waitForDeployment(): Promise<this>;

  interface: MyTokenBInterface;
