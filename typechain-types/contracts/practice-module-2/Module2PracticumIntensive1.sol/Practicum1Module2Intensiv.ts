...
export interface Practicum1Module2IntensivInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addToFixedArray"
...
export interface Practicum1Module2Intensiv extends BaseContract {
  connect(runner?: ContractRunner | null): Practicum1Module2Intensiv;
  waitForDeployment(): Promise<this>;

  interface: Practicum1Module2IntensivInterface;
