...
export interface MathContractInterface extends Interface {
  getFunction(
...
export interface MathContract extends BaseContract {
  connect(runner?: ContractRunner | null): MathContract;
  waitForDeployment(): Promise<this>;

  interface: MathContractInterface;
