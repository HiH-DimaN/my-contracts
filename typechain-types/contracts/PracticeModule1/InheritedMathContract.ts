...
export interface InheritedMathContractInterface extends Interface {
  getFunction(
...
export interface InheritedMathContract extends BaseContract {
  connect(runner?: ContractRunner | null): InheritedMathContract;
  waitForDeployment(): Promise<this>;

  interface: InheritedMathContractInterface;
