...
export interface MShopInterface extends Interface {
  getFunction(
...
export interface MShop extends BaseContract {
  connect(runner?: ContractRunner | null): MShop;
  waitForDeployment(): Promise<this>;

  interface: MShopInterface;
