...
export interface MCSTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MCSToken extends BaseContract {
  connect(runner?: ContractRunner | null): MCSToken;
  waitForDeployment(): Promise<this>;

  interface: MCSTokenInterface;
  ...
  burn: TypedContractMethod<
    [_from: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  mint: TypedContractMethod<
    [amount: BigNumberish, shop: AddressLike],
    [void],
    "nonpayable"
  >;
