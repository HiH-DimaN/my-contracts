...
export interface RoleBasedAccessControlInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "adminFunction",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface RoleBasedAccessControl extends BaseContract {
  connect(runner?: ContractRunner | null): RoleBasedAccessControl;
  ...
  addUser: TypedContractMethod<[account: AddressLike], [void], "nonpayable">;

  adminFunction: TypedContractMethod<[], [void], "nonpayable">;
  ...
  removeUser: TypedContractMethod<[account: AddressLike], [void], "nonpayable">;
  ...
  userFunction: TypedContractMethod<[], [void], "nonpayable">;
