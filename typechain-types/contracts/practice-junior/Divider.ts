...
export interface DividerInterface extends Interface {
  getFunction(nameOrSignature: "divide"): FunctionFragment;
...
export interface Divider extends BaseContract {
  connect(runner?: ContractRunner | null): Divider;
