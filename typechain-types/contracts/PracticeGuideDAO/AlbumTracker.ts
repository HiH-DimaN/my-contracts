...
export interface AlbumTrackerInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "creatAlbum", data: BytesLike): Result;
...
export namespace AlbumStateChangedEvent {
  export type InputTuple = [
    ...
    _albuumAddress: AddressLike
  ];
  export type OutputTuple = [
    _albumIndex: bigint,
    _stateNum: bigint,
    _albuumAddress: string
  ];
...
export interface AlbumTracker extends BaseContract {
  ...
  creatAlbum: TypedContractMethod<
  ...
  filters: {
    "AlbumStateChanged(uint256,uint256,address)": TypedContractEvent<
      AlbumStateChangedEvent.InputTuple,
      AlbumStateChangedEvent.OutputTuple,
      AlbumStateChangedEvent.OutputObject
    >;
