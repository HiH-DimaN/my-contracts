...
abstract contract MyERC20 is IERC20, Ownable {
    ...
    function transfer(address _to, uint256 amount) public virtual override returns (bool) {
        ...
        _transfer(owner, _to, amount); // Вызываем внутреннюю функцию _transfer
        return true;
    }
    ...
    function approve(address spender, uint256 amount) public virtual override returns (bool) {
        address owner = _msgSender(); // Получаем адрес отправителя транзакции (владельца токенов)
        _approve(owner, spender, amount); // Вызываем внутреннюю функцию _approve, передавая адрес владельца
        return true;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        _balances[from] += amount; // Увеличиваем баланс получателя
    ...
    function _beforeTokenTransfer(
        ...
        // Логика, которая будет выполняться перед каждым переводом токенов
        // Например:
        // - Проверка, что отправитель не находится в черном списке
        // - Обновление каких-либо данных, связанных с балансами
        // ...
    }
    ...
    function _afterTokenTransfer(
        ...
        // Логика, которая будет выполняться после каждого перевода токенов
        // Например:
        // - Обновление каких-либо данных, связанных с балансами
        // - Эмитирование дополнительных событий
        // ...
    }
}