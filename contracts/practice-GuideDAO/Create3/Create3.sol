...
library Create3 {
     ...
     *
     *   0x67 363d3d37363d34f0     3d  52  60 08   60 18    f3
     *   0x00  0x67  0x67XXXXXXXXXXXXXXXX  PUSH8 bytecode  0x363d3d37363d34f0
     *   0x01  0x3d  0x3d                  RETURNDATASIZE  0 0x00000000000000363d3d37363d34f0
     *   0x02  0x52  0x52                  MSTORE
     *   0x03  0x60  0x6008                PUSH1 08        8
     *   0x04  0x60  0x6018                PUSH1 18        24 8
     *   0x05  0xf3  0xf3                  RETURN(24...24+8)
     *
     *   0x363d3d37363d34f0:
    ...
    function addressOf(bytes32 _salt) internal view returns (address) {
        ...
        // 0xD6 || 0x94 || [proxy_address] || 0x01
        // 0x94 || [proxy_address] || 0x01 - payload
        // total size: 20 + 1 + 1 = 22 bytes = 0x16

        // 0x94 - address prefix
        // RLP Prefix for Strings 0-55 bytes: 0x80 + length.
        // 0x80 + 0x14 = 0x94

        // 0xD6
        // 0xc0 - rlp list prefix
        // 0xc0 + 0x16 = 0xd6
